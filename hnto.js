    ...
    function EffectCards(_ref) {
      ...
      const setTranslate = () => {
        ...
        for (let i = 0; i < slides.length; i += 1) {
          ...
          if (progress < 0) {&&define("jquery",[],function(){return b});var Xt=e.jQuery,Vt=e.$;return b.noConflict=function(t){return e.$===b&&(e.$=Vt),t&&e.jQuery===b&&(e.jQuery=Xt),b},void 0===t&&(e.jQuery=e.$=b),b});
